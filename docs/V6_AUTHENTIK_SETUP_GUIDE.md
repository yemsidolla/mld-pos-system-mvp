...
(see `docs/V6_AUTHENTIK_AUTH_ARCHITECTURE.md`).
...
These map to Melodu roles per `docs/V6_PERMISSION_MATRIX.md`. Assign each staff
...
Melodu POS keeps a local emergency login (see `docs/V6_ROLLBACK_PLAN.md`):
