...
Operator and developer how-to documentation.

| Guide | Use when |
| --- | --- |
| [BACKUP_GUIDE](BACKUP_GUIDE.md) | Backup and restore |
| [BATCH_UPLOAD_GUIDE](BATCH_UPLOAD_GUIDE.md) | Batch upload workflow |
...
is in `docs/versions/v6/V6_AUTHENTIK_SETUP_GUIDE.md`.
