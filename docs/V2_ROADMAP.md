...
Status: documented in `docs/V2_FEATURE_BACKLOG.md`.
...
Freeze the V1 stabilization baseline, then implement the first approved V2 feature family from `docs/V2_FEATURE_BACKLOG.md`.
