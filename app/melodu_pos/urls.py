...
from reports.views import (
    ...
    daily_closing_checklist_view,
    expiry_report_view,
    low_stock_report_view,
    promotion_report_view,
    reports_index_view,
...
urlpatterns = [
    ...
    path("dashboard/api/scan/decode-image/", scan_decode_image_view, name="scan-decode-image"),
    ...
    path("dashboard/reports/daily-closing/", daily_closing_checklist_view, name="daily-closing-checklist"),
    ...
    path("dashboard/reports/promotions/", promotion_report_view, name="promotion-report"),
